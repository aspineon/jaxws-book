 ...
 * 2014-09-03T16:22:01.130+02:00
 * Generated source version: 2.7.7
 * 
 */
@WebServiceClient(name = "HelloWorldService", 
                  wsdlLocation = "file:/home/jboss/tmp/handlers/target/wsprovide/resources/HelloWorldService.wsdl",
                  targetNamespace = "http://hello.world.ns/") 
public class HelloWorldService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://hello.world.ns/", "HelloWorldService");
    public final static QName HelloWorldPort = new QName("http://hello.world.ns/", "HelloWorldPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/home/jboss/tmp/handlers/target/wsprovide/resources/HelloWorldService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/jboss/tmp/handlers/target/wsprovide/resources/HelloWorldService.wsdl");
        }
        WSDL_LOCATION = url;
    }
